...
namespace SensorPack.Addons.Mediapipe.ImageSource
{
  public abstract class ImageSource
  {
    ...
    public ImageTransformationOptions GetTransformationOptions(bool expectedToBeMirrored = false)
    {
      ...
      return ImageTransformationOptions.Build(shouldFlipHorizontally, shouldFlipVertically, rotation);
    }
  }
}
